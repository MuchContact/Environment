...
public class StringUtils {
	...
	public static String removeCommaValue(String values, String value) {
		return StringUtils.joinByComma(remove(StringUtils.splitByComma(values), value));
	}
	 ...
	 * @return
	 */
	public static int changeString2Color(String data){
		if(data==null||data.equals("")){
			...
			int tempCount=3;
			for(int i=tempData.length-1;i>=0&&tempCount>=0;i--){
				argb[tempCount]= TypeConvert.parseInt(tempData[i], 255);
				tempCount--;
			}
	...
	public static String changeMap2String(Map map) {
		...
		for(Iterator iterator = map.entrySet().iterator(); iterator.hasNext();) {
		    ...
		    sb.append(entry.getKey().toString()).append( sep ).append(null==entry.getValue()?"":  
		    entry.getValue().toString()).append (iterator.hasNext() ? sep2 : "");  
		}  
		return sb.toString();  
			
	}
	public static Map<String, String> changeString2Map(String mapString){
		String sep = "\\*\\*\\|\\|\\*\\*";
		String sep2 = "\\*\\*\\^\\^\\*\\*";
		Map<String, String> map = new HashMap<String, String>();
		String[] str = mapString.split(sep2);
		for(int i = 0; i < str.length; i++) {
			String[] s = str[i].split(sep);
	...
	public static String changeList2String(List<String> list) {
		...
		return StringUtils.joinBy(as, sep);
			
	}
	public static List<String> changeString2List(String listString){
		String sep = "\\*\\*@@\\*\\*";
		List<String> list = new ArrayList<String>();
		String[] as = listString.split(sep);
